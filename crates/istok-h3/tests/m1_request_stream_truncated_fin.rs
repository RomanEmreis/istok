...
#[test]
fn request_headers_truncated_with_fin_closes_connection() {
    ...
    let mut truncated = alloc::vec::Vec::with_capacity(request_header_len + 1);
    truncated.extend_from_slice(&request_header[..request_header_len]);
    truncated.push(0xaa);
